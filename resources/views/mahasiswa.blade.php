        ...
        <div class="container">
            ...
            <div class="row justify-content-center fs-5 text-center">
                <div class="col-lg-4 col-xs-12">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Saepe officiis ut nisi doloremque maiores quae illo aliquam recusandae minima eveniet totam, accusantium vero, eum tempora. Architecto maxime itaque laborum illo, repudiandae ratione nostrum nam expedita! Eveniet quibusdam veritatis a delectus, fugiat itaque ratione, reiciendis cum similique dicta consequuntur porro sapiente omnis quod quaerat fuga fugit ea laborum? Incidunt, nobis iste inventore accusantium voluptas commodi perferendis unde non? Perspiciatis alias eum deserunt numquam, enim in quidem officia omnis, praesentium molestias magni inventore voluptas, magnam explicabo. Accusantium omnis fugit quae ratione ipsa ut tempore, culpa, saepe distinctio fuga perferendis alias impedit deserunt?</p>
                </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{asset('oke/img/projects/1.jpg')}}" class="card-img-top" alt="projects 1">
                        <div class="card-body">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{asset('oke/img/projects/2.jpg')}}" class="card-img-top" alt="projects 2">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{asset('oke/img/projects/3.jpg')}}" class="card-img-top" alt="projects 3">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{asset('oke/img/projects/4.jpg')}}" class="card-img-top" alt="projects 4">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                    </div>
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        <img src="{{asset('oke/img/projects/5.jpg')}}" class="card-img-top" alt="projects 5">
                        <div class="card-body">
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                    </div>
